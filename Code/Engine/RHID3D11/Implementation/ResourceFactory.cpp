...
// clang-format off
EZ_BEGIN_STATIC_REFLECTED_TYPE(RHI::spDeviceResourceFactoryD3D11, RHI::spDeviceResourceFactory, 1, ezRTTINoAllocator)
...
namespace RHI
{
  ...
  ezSharedPtr<spInputLayout> spDeviceResourceFactoryD3D11::CreateInputLayout(const spInputLayoutDescription& description)
  {
