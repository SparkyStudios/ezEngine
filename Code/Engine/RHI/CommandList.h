...
namespace RHI
{
  ...
  public:
    ...
    void PushConstants(ezBitflags<spShaderStage> eStage, const void* pData, ezUInt32 uiOffset, ezUInt32 uiSize);
  ...
  protected:
    ...
    virtual void PushConstantsInternal(ezBitflags<spShaderStage> eStage, const void* pData, ezUInt32 uiOffset, ezUInt32 uiSize) = 0;
