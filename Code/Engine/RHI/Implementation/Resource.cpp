...
// clang-format off
EZ_BEGIN_STATIC_REFLECTED_TYPE(RHI::spDeferredDeviceResource, ezNoBase, 1, ezRTTINoAllocator)
EZ_END_STATIC_REFLECTED_TYPE;
// clang-format on

// clang-format off
EZ_BEGIN_STATIC_REFLECTED_TYPE(RHI::spDeviceResourceFactory, ezNoBase, 1, ezRTTINoAllocator)
EZ_END_STATIC_REFLECTED_TYPE;
// clang-format on
...
#pragma region spResourceHelper
  ...
  ezSharedPtr<spBufferRange> spResourceHelper::GetBufferRange(const spDevice* pDevice, ezSharedPtr<spShaderResource> pResource, ezUInt32 uiOffset)
  {
    if (pResource == nullptr)
      return nullptr;
