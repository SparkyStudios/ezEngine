...
inline ezStreamWriter& operator<<(ezStreamWriter& inout_stream, const RAI::spMesh::VertexStream& stream)
{
...
inline ezStreamReader& operator>>(ezStreamReader& inout_stream, RAI::spMesh::VertexStream& ref_stream)
{
