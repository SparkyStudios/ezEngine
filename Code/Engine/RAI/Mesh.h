...
inline ezStreamWriter& operator<<(ezStreamWriter& inout_stream, const RAI::spMesh::Vertex& vertex)
{
...
inline ezStreamReader& operator>>(ezStreamReader& inout_stream, RAI::spMesh::Vertex& ref_vertex)
{
