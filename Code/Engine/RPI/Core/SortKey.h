...
namespace RPI
{
  /// \brief A struct to hold the sort key for a \a spRenderObject.
  ///
  /// The sort key is used to sort the render data in a \a spRenderingStage.
  /// Sort keys are generated by a \a spSortMode implementation.
  struct spSortKey
  {
