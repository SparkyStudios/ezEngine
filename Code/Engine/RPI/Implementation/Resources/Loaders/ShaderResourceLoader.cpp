...
#include <RPI/Resources/Loaders/ShaderResourceLoader.h>
...
// clang-format off
EZ_BEGIN_SUBSYSTEM_DECLARATION(RPI, ShaderResource)
...
EZ_STATICLINK_FILE(RPI, RPI_Implementation_Resources_Loaders_ShaderResourceLoader);
