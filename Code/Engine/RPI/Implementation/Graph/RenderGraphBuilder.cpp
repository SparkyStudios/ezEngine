...
spResourceHandle spRenderGraphBuilder::Import(ezSharedPtr<spBuffer> pBuffer)
{
  return Import(pBuffer, spRenderGraphResourceType::Buffer);
}

spResourceHandle spRenderGraphBuilder::Import(ezSharedPtr<spTexture> pTexture)
{
  return Import(pTexture, spRenderGraphResourceType::Texture);
}

spResourceHandle spRenderGraphBuilder::Import(ezSharedPtr<spRenderTarget> pRenderTarget)
{
  return Import(pRenderTarget, spRenderGraphResourceType::RenderTarget);
}

spResourceHandle spRenderGraphBuilder::Import(ezSharedPtr<spSampler> pSampler)
{
...
spResourceHandle spRenderGraphBuilder::Import(ezSharedPtr<spDeviceResource> pResource, const ezEnum<spRenderGraphResourceType>& eType)
{
