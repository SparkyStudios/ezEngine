...
{
  // clang-format off
  EZ_BEGIN_DYNAMIC_REFLECTED_TYPE(spMaterialFunctor_ref, 1, ezRTTIDefaultAllocator<spMaterialFunctor_ref>)
  EZ_END_DYNAMIC_REFLECTED_TYPE;
  // clang-format on

  spMaterialFunctor_ref::spMaterialFunctor_ref()
    : spMaterialFunctor("ref")
  {
  }
