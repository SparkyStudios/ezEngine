...
class EZ_RENDERERCORE_DLL ezDepthOfFieldPass : public ezRenderPipelinePass
{
  EZ_ADD_DYNAMIC_REFLECTION(ezDepthOfFieldPass, ezRenderPipelinePass);

public:
  ezDepthOfFieldPass();
  ~ezDepthOfFieldPass() override;
...
protected:
  ...
  ezRenderPipelineNodeInputPin m_PinDepth;
