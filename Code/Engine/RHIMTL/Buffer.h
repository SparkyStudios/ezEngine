...
namespace RHI
{
  ...
  public:
    ...
    [[nodiscard]] EZ_ALWAYS_INLINE MTL::Buffer* GetMTLBuffer() const { return m_pBuffer; }
  ...
  public:
    ...
    [[nodiscard]] EZ_ALWAYS_INLINE bool operator==(const spBufferRangeMTL& rhs) const
    {
      return m_pBuffer == rhs.m_pBuffer && GetOffset() == rhs.GetOffset() && GetSize() == rhs.GetSize();
    }

    [[nodiscard]] EZ_ALWAYS_INLINE bool operator!=(const spBufferRangeMTL& rhs) const { return !(*this == rhs); }
