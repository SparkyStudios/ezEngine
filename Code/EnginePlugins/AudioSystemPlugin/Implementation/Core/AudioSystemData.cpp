...
EZ_BEGIN_DYNAMIC_REFLECTED_TYPE(ezAudioSystemSwitchStateData, 1, ezRTTINoAllocator)
EZ_END_DYNAMIC_REFLECTED_TYPE;

EZ_BEGIN_DYNAMIC_REFLECTED_TYPE(ezAudioSystemEnvironmentData, 1, ezRTTINoAllocator)
EZ_END_DYNAMIC_REFLECTED_TYPE;
